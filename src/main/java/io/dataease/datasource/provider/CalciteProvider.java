...
public class CalciteProvider {
    ...
    private final String FILE_PATH = "/Users/ideamac/env/workspaces/de-server/drivers";
    private final String CUSTOM_PATH = "/Users/ideamac/env/workspaces/de-server/custom-drivers/";
    ...
    private void addCustomFunctions(SchemaPlus rootSchema) {
        ...
        for (Method method : methods) {
            ...
            ScalarFunction func = ScalarFunctionImpl.create(ScalarFunctions.class, method.getName());
            rootSchema.add(name, func);
        }
    }
